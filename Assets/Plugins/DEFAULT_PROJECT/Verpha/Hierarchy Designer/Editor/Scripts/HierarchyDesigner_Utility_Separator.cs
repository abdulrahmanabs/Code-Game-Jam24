...
namespace Verpha.HierarchyDesigner
{
    public class HierarchySeparatorWindow : EditorWindow
    {
        ...
        [MenuItem("Tools/Hierarchy Designer/Hierarchy Separator/Hierarchy Separator Manager")]
    ...
    public class HierarchyDesigner_Utility_Separator
    {
        ...
        [MenuItem("Tools/Hierarchy Designer/Hierarchy Separator/Create Default Separator", false, 2)]
        ...
        [MenuItem("Tools/Hierarchy Designer/Hierarchy Separator/Create All Separators", false, 1)]
        ...
        [MenuItem("Tools/Hierarchy Designer/Hierarchy Separator/Create Missing Separators", false, 2)]
