...
namespace Verpha.HierarchyDesigner
{
    public class HierarchyFolderWindow : EditorWindow
    {
        ...
        [MenuItem("Tools/Hierarchy Designer/Hierarchy Folder/Hierarchy Folder Manager")]
    ...
    public class HierarchyDesigner_Utility_Folder
    {
        ...
        [MenuItem("Tools/Hierarchy Designer/Hierarchy Folder/Create Default Folder", false, 2)]
        ...
        [MenuItem("Tools/Hierarchy Designer/Hierarchy Folder/Create All Folders", false, 1)]
        ...
        [MenuItem("Tools/Hierarchy Designer/Hierarchy Folder/Create Missing Folders", false, 2)]
